...
<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-4">
            <?= $form
                ->field($model, 'contract_id')
                ->dropDownList(ArrayHelper::map(ClientContract::find()->all(), 'id', 'contract_number'), ['id' => 'contract_id', 'class' => 'form-control', 'prompt' => 'Select a Contract ...'])
        ...
        <div class="col-md-4">
            ...
            <?= $form
                ->field($model, 'client_id', ['enableClientValidation' => false])
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'activityCodeArray')->dropDownList(ArrayHelper::map(MasterActivity::find()->all(), 'id', 'activity_name'), [
                'multiple' => 'multiple',
                'prompt' => 'Select an option...',
                'id' => 'activity',
            ]) ?>
    ...
    <?= $form->field($model, 'status')->dropDownList([1 => 'RO Received', 2 => 'Work In Progress', 3 => 'Work Completed', 4 => 'Invoiced', 9 => 'Paid'], ['prompt' => '- Select Status -', 'value' => 1]) ?>
</div>
